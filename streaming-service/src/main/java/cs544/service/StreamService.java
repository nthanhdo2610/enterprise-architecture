...
public class StreamService {
    ...
    public void setGame(Game g, String token) {
        this.game = g;
        this.token = token;
    }
    ...
    public void decreaseMinutes() {
        if (game != null) {
            ...
            if (game.getDurationMinutes() == 0) {
                ResponseEntity<String> response = connectToStream(game, "setStopFromStream", token);
                ...
                String msg = "GAME RESULT (" + game.getGoalHome() + ":" + game.getGoalVisit() + ") MINUTES: "
    ...
    public ResponseEntity<String> connectToStream(Game game, String method, String token) {
        ...
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromUriString("http://localhost:8081/sport/" + method)
