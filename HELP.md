...
* The original package name 'miu.edu.cs544.enterprise-architecture' is invalid and this project uses 'miu.edu.cs544.enterprisearchitecture' instead.
...
* [Validation](https://docs.spring.io/spring-boot/docs/3.1.1-SNAPSHOT/reference/htmlsingle/#io.validation)
