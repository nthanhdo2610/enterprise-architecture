    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <form:form method="POST" action="../contacts/${contact.id}/addPhone" modelAttribute="phone">
        ...
        <tr>
            ...
            <td>
                ...
                <form:form method="POST" action="../contacts/${contact.id}/addEmail" modelAttribute="email">
